...
public class ImageCreate extends JFrame {
	...
	private ImageIcon rocket_Select1Img = new ImageIcon(this.getClass().getResource("/resources/images/rocketselect1.png"));
	private ImageIcon rocket_Select2Img = new ImageIcon(this.getClass().getResource("/resources/images/rocketselect2.png"));
	private ImageIcon rocket_Select3Img = new ImageIcon(this.getClass().getResource("/resources/images/rocketselect3.png"));
    
	JButton main_Start_Button = new JButton(main_startImg);
	JButton game_Start_Button = new JButton(main_startImg);
    ...
    public void ImageLoadContent() // 페이지 이미지를 받아와 저장한다.
    {
    	...
    	URL startPageImgUrl = this.getClass().getResource("/resources/images/startPageImg.png");
    ...
    {
    	main_Start_Button.setBounds(Framework.frameWidth/2-250,Framework.frameHeight/2+150,main_Start_Button.getWidth(),main_Start_Button.getHeight());
    ...
    {
    	rocket1Select_Button.setBounds(Framework.frameWidth/2-40,Framework.frameHeight/2-320,rocket1Select_Button.getWidth(),rocket1Select_Button.getHeight());
    	rocket1Select_Button.setContentAreaFilled(false);
    	rocket1Select_Button.setBorderPainted(false);
    	rocket2Select_Button.setBounds(Framework.frameWidth/2-80,Framework.frameHeight/2-90,rocket2Select_Button.getWidth(),rocket2Select_Button.getHeight());
    	rocket2Select_Button.setContentAreaFilled(false);
    	rocket2Select_Button.setBorderPainted(false);
    	rocket3Select_Button.setBounds(Framework.frameWidth/2-40,Framework.frameHeight/2+130,rocket3Select_Button.getWidth(),rocket3Select_Button.getHeight());
    ...
    {
    	game_Start_Button.setBounds(Framework.frameWidth/2-50,Framework.frameHeight/2,game_Start_Button.getWidth(),game_Start_Button.getHeight());
