...
public class Game {
   ...
   /**
     ...
     */
     public void shooting(long gameTime, Point mousePosition) {
        
        if(StageBase.stage_count==6) {
           if(shootingobstacle.getCoordinateX()%2==0) {
              Laser laser = new Laser();
                laserList.add(laser);
           }
        }
        else {
           if(shootingobstacle.getCoordinateX()%15==0) {
                Laser laser = new Laser();
                laserList.add(laser);
             }
        }
    ...
    public void UpdateGame(long gameTime, Point mousePosition)
    {
        ...
        for(int i=0;i<laserList.size();i++) {
         ...
         shooting(gameTime,mousePosition);
